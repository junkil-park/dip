...
# Summary
---
This LIP describes the conceptual model and implementation of access control on the Diem blockchain.
...
* DiemRoot - The root authority of LPN. Controlled jointly by LN and the Association Council.
...
* Designated Dealer - An entity with the authority to place  mint and burn orders for Diem Coins with LN and interact with the Diem Reserve.
